...
class ClassicHeader extends RefreshIndicator {
  ...
  const ClassicHeader({
    ...
    this.spacing: 15.0,
    this.refreshingIcon,
    this.failedIcon: const Icon(Icons.error, color: Colors.white38),
    this.completeIcon: const Icon(Icons.done, color: Colors.white38),
    this.idleIcon = const Icon(Icons.arrow_downward, color: Colors.white38),
    this.releaseIcon = const Icon(Icons.refresh, color: Colors.white38),
  }) : super(
    key: key,
